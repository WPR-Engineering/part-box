class AssetLabelMediumWorker
  ...
  def perform(asset_tag_id)
    ...
    tag_data = File.read(File.expand_path(CONFIG[:LABEL_PRINTING][:DEFAULT_MED_ZPL])).gsub(/#TAG_URL|#TAG_CODE|#PART_NUMBER|#PART_DESCRPTION/, replace)
